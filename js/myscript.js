...
$(document).ready(function () {
  $(".owl-carousel").owlCarousel({
      ...
      autoplayTimeout: 3000, // Set autoplay interval in milliseconds (3 seconds here)
      autoplayHoverPause: true, // Pause autoplay on hover
      responsive: {
          0: {
              items: 1, // Show 1 item for mobile view
          },
          768: {
              items: 2, // Show 2 items for tablet view
          },
          1024: {
              items: 3, // Show 3 items for desktop view
          },
      },
  });
});
